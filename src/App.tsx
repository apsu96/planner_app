...
import { AppContainer, DrawerContainer, MobileMenuContainer, PageContainer, PageTitle, PageTitleContainer } from "./components/UIKit.styled";
...
function App() {
  ...
  const pageTitle = (
    <PageTitleContainer>
      {currentView.myDay ? <TasksIcon selected={false} /> : currentView.statistics ? <StatisticsIcon selected={false} /> : <PlanningIcon selected={false} />}
      <PageTitle>{currentView.myDay ? 'Tasks for Today' : currentView.statistics ? 'Statistics' : 'Planning'}</PageTitle>
    </PageTitleContainer>
  );
